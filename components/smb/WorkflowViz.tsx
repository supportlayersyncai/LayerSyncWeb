    ...
    return (
        <section className="relative py-20 px-6 max-w-7xl mx-auto z-20">
            <div className="text-center mb-20">
                <h2 className="text-4xl font-light mb-6 text-white">The <span className="text-blue-500">Invisible</span> Workforce</h2>
                <p className="sub-heading max-w-2xl mx-auto">LayerSync replaces your "Busy Work" with intelligent, tireless agents that run 24/7.</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 relative">
                ...
                {steps.map((step, i) => (
                    <React.Fragment key={i}>
                        ...
                        >
                            <div className={`w-20 h-20 rounded-2xl ${step.color} bg-opacity-20 flex items-center justify-center text-white border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-sm group hover:scale-110 transition-transform duration-300`}>
                            ...
                            <div className="text-center">
                                <div className="text-xs uppercase tracking-widest font-bold text-white mb-1">Step 0{i + 1}</div>
                                <div className="text-lg text-white/70">{step.label}</div>
                            </div>
                        </motion.div>
