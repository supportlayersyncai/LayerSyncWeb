...
import { Sun, Moon, Menu, X, ArrowRight, ChevronDown, Building2, Cpu, Globe, Phone, ShieldCheck, GraduationCap } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ isDarkMode, setIsDarkMode }) => {
    ...
    const solutionLinks = [
        ...
        { name: "Sync Academy", href: "/solutions/academy", icon: <GraduationCap className="w-4 h-4" />, desc: "Corporate AI fluency training" },
