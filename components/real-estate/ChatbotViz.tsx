...
export const ChatbotViz: React.FC = () => {
    ...
    return (
        <section className="relative py-32 px-6 max-w-7xl mx-auto z-20">
            <div className="glass-card rounded-[48px] p-10 md:p-16 border border-white/5 bg-gradient-to-br from-purple-900/20 to-blue-900/20">
                <div className="grid md:grid-cols-2 gap-16">
                    <div className="order-2 md:order-1 relative h-[500px] bg-black/40 rounded-[32px] border border-white/10 p-6 overflow-hidden flex flex-col">
                        <div className="flex items-center gap-3 border-b border-white/5 pb-4 mb-4">
                            <div className="w-3 h-3 rounded-full bg-red-500" />
                            <div className="w-3 h-3 rounded-full bg-yellow-500" />
                            <div className="w-3 h-3 rounded-full bg-green-500" />
                            <span className="ml-2 text-xs text-white/40 font-mono">LayerSync Agent v2.0</span>
                        </div>
                                ...
                                {messages.map((msg) => (
                                    ...
                                    >
                                        <div className={`max-w-[80%] rounded-2xl p-4 text-sm leading-relaxed ${msg.sender === 'user'
                                            ...
                                            : 'bg-purple-600 text-white rounded-bl-none shadow-lg shadow-purple-900/50'
                                            }`}>
                                            {msg.text}
                                        </div>
                                    </motion.div>
                        ...
                        <div className="mt-4 pt-4 border-t border-white/5 flex gap-3">
                            <div className="flex-1 h-10 rounded-full bg-white/5 animate-pulse" />
                    ...
                    <div className="order-1 md:order-2 flex flex-col justify-center text-white">
                        <div className="w-16 h-16 rounded-2xl bg-purple-500/20 flex items-center justify-center mb-8 text-purple-400">
                            <MessageSquare className="w-8 h-8" />
                        </div>
                        <h2 className="text-4xl md:text-5xl font-light mb-6">Automated <span className="text-purple-400 font-normal">*Lead Qual*</span></h2>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-white mb-1">Instant Response</h4>
                                    <p className="text-sm text-white/50">Engagement under 3 seconds drastically increases conversion.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-2 rounded-lg bg-blue-500/10 text-blue-500 mt-1"><User className="w-4 h-4" /></div>
                                <div>
                                    <h4 className="font-bold text-white mb-1">CRM Sync</h4>
                                    <p className="text-sm text-white/50">Automatically creates contacts in Follow Up Boss or HubSpot.</p>
                                </div>
                            </div>
                        </div>
                    </div>
